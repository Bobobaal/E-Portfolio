  ...
  return (
    ...
    <Grid item className="pageComponent">
      ...
      <Typography className="text">
        ...
        Uiteindelijk gaf ik dan de verschillende rijen in de tabel een eigen kleur via een css klasse afhankelijk van de naam van de serie om te makkelijker uiteen te houden in een tabel met zeer veel rijen. Ik deed dit eerst handmatig, maar uiteindelijk heb ik een kleine javascript geschreven die het voor mij deed (<Link href="https://github.com/Bobobaal/Arrowverse-watchlist/blob/main/js/autoclasses.js" target="_blank" rel="noopener" underline="hover">autoclasses script op Github</Link>).
        Naarmate er meer series bijkwamen werd het mij toch wat te veel om telkens nieuwe rijen toe te voegen aan de HTML naarmate de persoon die de lijst gemaakt had het steeds up-to-date bracht.
        Ik had in het vak webapplicaties 2 leren werken met klassen en DOM manipulatie in javascript en besloot dus om het maken van die tabellen te automatiseren samen met de juiste CSS klassen toe te voegen naarmate ik een aflevering had gezien en heb ook de vorige functionaliteit eraan toegevoegd (<Link href="https://github.com/Bobobaal/Arrowverse-watchlist/blob/main/js/autoEpisodes.js" target="_blank" rel="noopener" underline="hover">autoEpisodes script op Github</Link>).
