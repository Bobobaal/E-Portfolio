  ...
  return (
    <>
      ...
      <Typography className="text">
        ...
        De website kon zeer gemakkelijk gemaakt worden in HTML, maar heb PHP gebruikt voornamelijk zodat bepaalde delen niet opnieuw moesten gekopieerd en geplakt worden op verschillende HTML pagina's. <br />
